...
import { AnthropicApiProvider, classifyAnthropicApiError, isAnthropicSelected, isAnthropicAvailable } from './worker/AnthropicApiProvider.js';
...
export class WorkerService implements WorkerRef {
  ...
  constructor() {
    ...
    this.anthropicAgent = new AnthropicApiProvider(this.dbManager, this.sessionManager);
